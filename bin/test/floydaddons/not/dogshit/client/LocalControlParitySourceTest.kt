...
class LocalControlParitySourceTest {
    ...
    fun `active local-control bridge preserves Floyd endpoint and auth contract`() {
        ...
        val active = source("src/main/kotlin/floydaddons/not/dogshit/client/features/impl/misc/FloydLocalControl.kt")
    ...
    fun `active local-control screen mouse key and state surfaces preserve Floyd bridge shape`() {
        val floyd = source("vendor/floydaddons-fabric/app/src/main/java/floydaddons/not/dogshit/client/control/LocalMinecraftControlServer.java")
        val active = source("src/main/kotlin/floydaddons/not/dogshit/client/features/impl/misc/FloydLocalControl.kt")
        val legacyGui = source("src/main/kotlin/floydaddons/not/dogshit/client/clickgui/LegacyFloydClickGUI.kt")
        ...
        assertContains(source("src/main/kotlin/floydaddons/not/dogshit/client/features/impl/render/FloydMobEsp.kt"), "\"stalkEnabled\" to stalkEnabled()")
    }
