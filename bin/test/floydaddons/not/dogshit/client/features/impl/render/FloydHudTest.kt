...
class FloydHudTest {
    ...
    fun `legacy hud popup exposes minecraft font toggles under the correct entries`() {
        ...
        assertTrue(legacy.contains("hudSetting(FloydHud, \"Inventory HUD\")"))
        assertTrue(legacy.contains("hudSetting(FloydHud, \"Day Tracker\")"))
        assertTrue(legacy.contains("hudSetting(FloydHud, \"Scoreboard HUD\")"))
        assertTrue(legacy.contains("if (entry.label in setOf(\"Inventory HUD\", \"Day Tracker\", \"Custom Scoreboard\"))"))
    ...
    fun `scoreboard HUD renderer preserves Floyd sidebar ordering gate and footer`() {
        ...
        assertTrue(active.contains("private fun GuiGraphics.drawScoreboardText(text: ScoreboardText) {"))
        ...
        assertTrue(active.contains("val fontHints = ArrayList<Boolean>()"))
        ...
        assertTrue(active.contains("private fun safeScoreboardHudScale(): Float ="))
