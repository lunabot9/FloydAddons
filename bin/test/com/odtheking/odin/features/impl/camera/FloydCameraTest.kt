...
class FloydCameraTest {
    ...
    fun `camera cycle reset persists like Floyd perspective mixin`() {
        ...
        val active = Files.readString(root.resolve("src/main/kotlin/com/odtheking/odin/features/impl/camera/FloydCamera.kt")).replace("\r\n", "\n")
    ...
    fun `F5 scroll distance persists like Floyd mouse mixin`() {
        ...
        val activeCamera = Files.readString(root.resolve("src/main/kotlin/com/odtheking/odin/features/impl/camera/FloydCamera.kt")).replace("\r\n", "\n")
        val activeMixin = Files.readString(root.resolve("src/main/java/com/odtheking/mixin/mixins/CameraMouseMixin.java")).replace("\r\n", "\n")
    ...
    fun `freecam and freelook toggles remain runtime-only like Floyd camera config`() {
        ...
        val activeCamera = Files.readString(root.resolve("src/main/kotlin/com/odtheking/odin/features/impl/camera/FloydCamera.kt")).replace("\r\n", "\n")
        val runtimeBoolean = Files.readString(root.resolve("src/main/kotlin/com/odtheking/odin/clickgui/settings/impl/BooleanSetting.kt")).replace("\r\n", "\n")
