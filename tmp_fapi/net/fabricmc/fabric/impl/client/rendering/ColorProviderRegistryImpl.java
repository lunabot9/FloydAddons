...
public abstract class ColorProviderRegistryImpl<T, Provider, Underlying> implements ColorProviderRegistry<T, Provider> {
	public static final ColorProviderRegistryImpl<class_2248, class_322, class_324> BLOCK = new ColorProviderRegistryImpl<class_2248, class_322, class_324>() {
		@Override
		void registerUnderlying(class_324 map, class_322 mapper, class_2248 block) {
			map.method_1690(mapper, block);
		}
	};
