...
class ModuleConfigTest {
    ...
    private class LegacyCustomSkinModule : Module(
        ...
        val featureEnabled by BooleanSetting("Enabled", false, desc = "Test setting.")
        val skin by floydaddons.not.dogshit.client.clickgui.settings.impl.StringSetting("Skin", "", 96, desc = "Test skin.")
    }
    ...
    private class LegacyCustomCapeModule : Module(
        ...
        val featureEnabled by BooleanSetting("Enabled", false, desc = "Test setting.")
        val image by floydaddons.not.dogshit.client.clickgui.settings.impl.StringSetting("Image", "", 96, desc = "Test image.")
    }
    ...
    private class LegacyRenderModule : Module(
        ...
        val instanceTitle by floydaddons.not.dogshit.client.clickgui.settings.impl.StringSetting("Instance Title", "", 64, desc = "Test title.")
    }
    ...
    private class LegacyNeckHiderModule : Module(
        ...
        val defaultNick by floydaddons.not.dogshit.client.clickgui.settings.impl.StringSetting("Default Nick", "", 64, desc = "Test nick.")
    }
