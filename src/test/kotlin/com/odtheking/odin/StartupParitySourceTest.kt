...
class StartupParitySourceTest {
    ...
    fun `active initializer preserves Floyd startup surfaces through Odin scaffold`() {
        val active = source("src/main/kotlin/com/odtheking/odin/FloydAddonsMod.kt")
        val moduleManager = source("src/main/kotlin/com/odtheking/odin/features/ModuleManager.kt")
    ...
    fun `event dispatcher exposes title-screen ticks and render hooks needed by Floyd modules`() {
        val dispatcher = source("src/main/kotlin/com/odtheking/odin/events/EventDispatcher.kt")
        val eventBus = source("src/main/kotlin/com/odtheking/odin/events/core/EventBus.kt")
        val renderUtils = source("src/main/kotlin/com/odtheking/odin/utils/render/RenderUtils.kt")
        val compatibility = source("src/main/kotlin/com/odtheking/odin/features/impl/misc/FloydCompatibility.kt")
        val discord = source("src/main/kotlin/com/odtheking/odin/features/impl/misc/FloydDiscordPresence.kt")
        val localControl = source("src/main/kotlin/com/odtheking/odin/features/impl/misc/FloydLocalControl.kt")
    ...
    fun `update checker waits for a player before checking or delivering messages`() {
        ...
        val active = source("src/main/kotlin/com/odtheking/odin/features/impl/misc/FloydUpdateChecker.kt")
    ...
    fun `taskbar icon preserves Floyd resource loading and failure semantics`() {
        ...
        val active = source("src/main/kotlin/com/odtheking/odin/features/impl/misc/FloydTaskbarIcon.kt")
    ...
    fun `discord presence preserves Floyd app defaults callback loop and state text`() {
        ...
        val active = source("src/main/kotlin/com/odtheking/odin/features/impl/misc/FloydDiscordPresence.kt")
        ...
        assertTrue(active.contains("val shouldRun = enabled && presenceEnabled"), "Active Discord presence must remain controlled by the Odin module and Floyd Enabled switch")
    ...
    private fun source(path: String): String = Files.readString(root.resolve(path))
}
