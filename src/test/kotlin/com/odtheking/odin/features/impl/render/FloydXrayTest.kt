...
class FloydXrayTest {
    ...
    fun `xray editor actions save valid clicks unconditionally like Floyd GUI`() {
        ...
        val active = Files.readString(root.resolve("src/main/kotlin/com/odtheking/odin/features/impl/render/FloydXray.kt"))
        val floydEditor = Files.readString(root.resolve("vendor/floydaddons-fabric/app/src/main/java/floydaddons/not/dogshit/client/gui/ClickGuiScreen.java"))
        val floydScreen = Files.readString(root.resolve("vendor/floydaddons-fabric/app/src/main/java/floydaddons/not/dogshit/client/gui/XrayEditorScreen.java"))
