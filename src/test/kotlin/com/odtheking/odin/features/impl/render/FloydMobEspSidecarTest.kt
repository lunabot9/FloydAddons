...
class FloydMobEspSidecarTest {
    ...
    fun `stalk target blank input disables runtime stalk state like Floyd`() {
        ...
        val floyd = java.nio.file.Files.readString(root.resolve("vendor/floydaddons-fabric/app/src/main/java/floydaddons/not/dogshit/client/esp/StalkManager.java"))
        val active = java.nio.file.Files.readString(root.resolve("src/main/kotlin/com/odtheking/odin/features/impl/render/FloydMobEsp.kt"))
