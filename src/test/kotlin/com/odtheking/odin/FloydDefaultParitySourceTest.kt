...
class FloydDefaultParitySourceTest {
    ...
    fun `player camera animation hider and cosmetic defaults match vendored Floyd config`() {
        ...
        assertContains(nick, "BooleanSetting(\"Enabled\", false")
        ...
        assertContains(skin, "BooleanSetting(\"Custom Skin\", false")
        ...
        assertContains(renderConfig, "private static boolean capeEnabled = false;")
        assertContains(cape, "BooleanSetting(\"Enabled\", false")
        assertContains(renderConfig, "private static String selectedCapeImage = \"\";")
        assertContains(cape, "StringSetting(\"Image\", \"\"")
        assertContains(renderConfig, "private static boolean floydHatEnabled = false;")
        assertContains(cone, "BooleanSetting(\"Enabled\", false")
