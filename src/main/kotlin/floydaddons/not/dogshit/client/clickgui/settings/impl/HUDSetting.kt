...
class HUDSetting(
    ...
    ) : this(name, HudElement(x, y, scale, !toggleable, anchorRight, draw), toggleable, description, module)

    override val default: HudElement = hud.copy()
    override var value: HudElement = hud.copy()
